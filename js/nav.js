nav = '    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">' +
'      <a class="navbar-brand" href="index.html">Eldercare</a>' +
...
document.getElementById("nav_holder").innerHTML = nav.toString();

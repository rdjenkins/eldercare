...
document.write('<h1 data-target="#glb_0" data-toggle="collapse">Stroke / TIA</h1>');
...
document.write('</div><h2 data-target="#glb_1" data-toggle="collapse">TIA</h2>');
...
document.write('</div><h2 data-target="#glb_2" data-toggle="collapse">Acute stroke</h2>');
document.write('<div id="glb_2" class="collapse"><p>urgent brain imaging at most within 1 hour of arrival at hospital</p>');
document.write('</div><h2 data-target="#glb_3" data-toggle="collapse">Acute ischaemic stroke</h2>');
...
document.write('</div><h2 data-target="#glb_4" data-toggle="collapse">Acute haemorrhagic stroke</h2>');
...
document.write('</div><h2 data-target="#glb_5" data-toggle="collapse">Swallow assessment</h2>');
...
document.write('</div><h2 data-target="#glb_6" data-toggle="collapse">Early mobilisation</h2>');
...
document.write('</div><h2 data-target="#glb_7" data-toggle="collapse">DVT / PE prevention</h2>');
...
document.write('</div><h2 data-target="#glb_8" data-toggle="collapse">Hydration and nutrition</h2>');
...
document.write('</div><h2 data-target="#glb_9" data-toggle="collapse">Blood pressure in stroke / TIA</h2>');
...
document.write('</div><h2 data-target="#glb_10" data-toggle="collapse">Rehabilitation intensity</h2>');
document.write('<div id="glb_10" class="collapse"><p>at least 45 minutes per day</p>');
document.write('</div><h3 data-target="#glb_11" data-toggle="collapse">Source</h3>');

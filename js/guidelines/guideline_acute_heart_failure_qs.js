...
document.write('<h1 data-target="#glb_0" data-toggle="collapse">Acute Heart Failure</h1>');
document.write('<div id="glb_0" class="collapse"><p>Quality standards adapted from NICE QS103 2015 and CG187 2014</p>');
document.write('</div><h2 data-target="#glb_1" data-toggle="collapse">1 Natriuretic peptide</h2>');
...
document.write('</div><h2 data-target="#glb_2" data-toggle="collapse">2 ECHO</h2>');
...
document.write('</div><h2 data-target="#glb_3" data-toggle="collapse">3 Heart failure team</h2>');
...
document.write('</div><h2 data-target="#glb_4" data-toggle="collapse">4 Beta-blocker</h2>');
...
document.write('</div><h2 data-target="#glb_5" data-toggle="collapse">5 ACE inhibitors and aldosterone antagonist</h2>');
...
document.write('</div><h2 data-target="#glb_6" data-toggle="collapse">6 Follow-up</h2>');
...
document.write('</div><h3 data-target="#glb_7" data-toggle="collapse">Source</h3>');
